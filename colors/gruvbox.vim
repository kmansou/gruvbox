...
if !exists('g:gruvbox_contrast_dark')
  let g:gruvbox_contrast_dark='extra_hard'
endif
...
let s:gb.dark0_x_hard = ['#000000', 0]
let s:gb.dark0_hard   = ['#1d2021', 0]     " 29-32-33 '#1d2021'
...
if s:is_dark
  ...
  elseif g:gruvbox_contrast_dark == 'extra_hard'
    let s:bg0  = s:gb.dark0_x_hard
  endif
